			...
			if (this.props.multi && this.props.deepFilter) {
				if (this.state.currentValue && this.state.currentValue.options) {
					...
					this.setState({
						...
						_this3.replaceValue(currentValue, (_this3$replaceValue = {}, _defineProperty(_this3$replaceValue, _this3.props.labelKey, currentValue[_this3.props.labelKey] + ': ' + value[_this3.props.labelKey]), _defineProperty(_this3$replaceValue, _this3.props.valueKey, (_this3$props$valueKey = {}, _defineProperty(_this3$props$valueKey, _this3.props.valueKey, currentValue[_this3.props.valueKey]), _defineProperty(_this3$props$valueKey, _this3.props.subfilterKey, value[_this3.props.valueKey]), _this3$props$valueKey)), _this3$replaceValue));
					});
				} else {
					this.setState({
						focusedIndex: null,
