...
var Select = function (_React$Component) {
   ...
   */
			...
			if (this.props.multi && this.props.deepFilter) {
				if (this.state.currentValue && this.state.currentValue.options) {
					...
					this.setState({
						...
						_this3.replaceValue(currentValue, (_this3$replaceValue = {}, _defineProperty(_this3$replaceValue, _this3.props.labelKey, currentValue[_this3.props.labelKey] + ': ' + value[_this3.props.labelKey]), _defineProperty(_this3$replaceValue, _this3.props.valueKey, Object.assign({}, filteredCurrentValue, (_Object$assign = {}, _defineProperty(_Object$assign, _this3.props.valueKey, currentValue[_this3.props.valueKey]), _defineProperty(_Object$assign, _this3.props.subfilterKey, value[_this3.props.valueKey]), _Object$assign))), _this3$replaceValue));
					});
				} else {
					this.setState({
						focusedIndex: null,
		...
		value: function replaceValue(previousValue, newValue) {
			...
			var lastValueIndex = visibleOptions.indexOf(previousValue);

			var newValueArray = valueArray.filter(function (i) {
		...
		value: function filterOptions(excludeOptions) {
			...
			valueArray.forEach(function (value) {
				if (_typeof(value[_this8.props.valueKey]) === 'object' && value[_this8.props.valueKey] !== null) {
					var valueKey = value[_this8.props.valueKey][_this8.props.valueKey];
					var subfilterList = subfilters[valueKey] || [];
					subfilterList.push(value[_this8.props.valueKey][_this8.props.subfilterKey]);
			...
			if (this.props.deepFilter && this.state.currentValue && this.state.currentValue.options) {
				...
				valueArray.forEach(function (value) {
					if (_typeof(value[_this8.props.valueKey]) === 'object' && value[_this8.props.valueKey] !== null) {
						if (value[_this8.props.valueKey][_this8.props.valueKey] === valueKey) {
							_subfilters.push(value[_this8.props.valueKey][_this8.props.subfilterKey]);
						}
					}
				});
				...
				return filterOptions(this.state.currentValue.options.filter(function (option) {
				...
				// Maintain backwards compatibility with boolean attribute
				var _filterOptions = typeof this.props.filterOptions === 'function' ? this.props.filterOptions : _defaultFilterOptions2.default;
...
Select.propTypes = {
	...
	deepFilter: _propTypes2.default.bool, // whether each option can have further options to filter
